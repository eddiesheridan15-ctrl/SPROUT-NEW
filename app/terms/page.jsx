  ...
  return (
    <LegalShell title="Terms of Service" updated="13 June 2026">
      ...
      <ul>
        ...
        <li>
          You must not misuse the Services, including by submitting unlawful,
          offensive, infringing or misleading content, attempting to manipulate
          points or leaderboards, or interfering with the platform&rsquo;s
          operation or security.
        </li>
        <li>
          You are responsible for content you upload and confirm you have the
          right to share it. We may remove content that breaches these Terms.
        </li>
      </ul>

      <h2>3. The donation</h2>
      <p>
      ...
      <p>
        ...
        programme. You retain ownership of content you upload, and grant us a
        licence to host, display and use it to operate the Services and, where you
        have agreed, to showcase programme impact.
      </p>

      <h2>6. Availability</h2>
      <p>
        We aim to keep the Services available and working, but we do not guarantee
        uninterrupted or error-free operation. We may update, suspend or withdraw
        features, and will give reasonable notice of material changes affecting an
        active programme where we can.
      </p>

      <h2>7. Disclaimers</h2>
      <p>
        The Services are provided &ldquo;as is&rdquo; and &ldquo;as
        available&rdquo;. To the extent permitted by law, we exclude all implied
        warranties. Nothing in these Terms excludes liability that cannot be
        excluded under law, including for death or personal injury caused by
        negligence, or for fraud.
      </p>

      <h2>8. Limitation of liability</h2>
      <p>
        Subject to section 7, our total liability arising out of or in connection
        with a programme is limited to the fees paid for that programme. We are
        not liable for indirect or consequential loss, or for loss of profits,
        revenue, goodwill or anticipated savings.
      </p>

      <h2>9. Termination</h2>
      <p>
        Either party may terminate as set out in the Order, or immediately on
        written notice if the other commits a material breach that is not remedied
        within 14 days, or becomes insolvent. The donation commitment for a
        programme already underway survives termination unless otherwise agreed in
        writing.
      </p>
      ...
      <p>
        ...
        of England and Wales have exclusive jurisdiction, unless a different
        jurisdiction is required by mandatory local law.
      </p>

      <h2>12. Contact</h2>
      <p>
        Questions about these Terms can be sent to{" "}
        <a href="mailto:contact@renyu.co.uk">contact@renyu.co.uk</a> or via the
