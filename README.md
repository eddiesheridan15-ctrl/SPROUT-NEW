# Sprout website (Next.js)

This is the Sprout marketing site, rebuilt as an owned Next.js codebase. No platform
...
5. You get a free live URL like `sprout-xxxx.vercel.app`. Done.
...
3. Redeploy. The form at /#contact will now email hello@sproutclimate.com.
...
- Logo: the "S" mark is hand-built SVG in `components/SproutLogo.jsx`. Tweak colours/shape
